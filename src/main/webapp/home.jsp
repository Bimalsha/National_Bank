...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="#" onclick="downloadStatement(); return false;" class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center hover:shadow-md transition-all">
...
<script>
    ...
    function downloadStatement() {
        // Get the primary account number from the DOM
        let accountNumber = '';
        <% if (primaryAccount != null && primaryAccount.getAccountNumber() != null) { %>
        accountNumber = '<%= primaryAccount.getAccountNumber() %>';
        <% } %>

        if (!accountNumber) {
            alert('No account found to generate statement');
            return;
        }

        // Create an invisible form to submit
        const form = document.createElement('form');
        form.method = 'GET';
        form.action = 'downloadStatement';
        form.style.display = 'none';

        // Add account number parameter
